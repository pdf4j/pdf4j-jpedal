...
//        }
    ...
    public static BufferedImage createTransparentForm(final PdfObject XObject, final int fx, final int fy, final int fw, final int fh, final boolean isExtractingForm,
...
//        glyphDecoder.setFloatValue(SamplingUsed, samplingUsed);
        ...
        }else if(!parserOptions.isFlattenedForm()) //already allowed for in form flattening
        {
            formG2.translate(-fx, -diff);
        }
